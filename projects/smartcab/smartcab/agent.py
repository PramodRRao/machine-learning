...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False,epsilon=1, alpha=0.003):
        ...
        # Set any additional class parameters as needed
            #self.Q_matrix = dict((key, 0.0) for key in self.valid_actions)
        ...
        for state_tuple in itertools.product(*self.state_def):
            self.Q[state_tuple] = self.Q_matrix.copy()
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            self.t += 1
            #using N(t) = N(0)* exp(-alpha*t)
            #self.epsilon -= 0.05
            #self.epsilon = math.pow(0.5, self.t)
    ...
    def choose_action(self, state):
        ...
        if not self.learning or r < self.epsilon*100:
